...
Le **registre Agent Adapter Policy v1** rend cette frontière lisible sous Capability Router. Sa commande Tauri retourne un catalogue local signé et n'exécute rien : Codex CLI possède uniquement le pilote public borné ci-dessus ; Claude Code et Hermes Agent sont `detect_only`, sans scope, budget ou workspace autorisé. Détection, autorisation et consentement restent trois états distincts.
