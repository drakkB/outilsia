...
function main() {
  ...
  assertIncludes(html, [
    ...
    'const directDownloadPrefix = "/static/downloads/local-cockpit/"',
    'const trackedUrlFor = (file) => file?.name',
    'bindStaticDownloadTracking(release)',
    'trackedUrlFor(file)',
    ...
    'local-cockpit-model-autopilot-v1.png?v=20260710',
