...
const release = {
  ...
  release_notes: [
    ...
    "AI Capability Passport v1.3 : export JSON optionnel lié à la machine et au build avec capacités, modèles, preuves, recommandation, dernier préflight d'installation sans chemin personnel, contrat de passerelle locale et SHA-256 d'intégrité — pas une signature d'identité.",
