...
const release = {
  ...
  release_notes: [
    ...
    "AI Capability Passport v1.2 : export JSON optionnel lié à la machine et au build avec capacités, modèles, preuves, recommandation, limites, contrat de passerelle locale et SHA-256 d'intégrité — pas une signature d'identité.",
