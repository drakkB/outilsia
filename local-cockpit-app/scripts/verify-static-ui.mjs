...
const requiredFeatureText = [
  ...
  ["rust release metadata command", rust, "async fn fetch_release_metadata()"],
  ["tauri release metadata registration", rust, "fetch_release_metadata,"],
  ["desktop release metadata invoke", js, 'invoke("fetch_release_metadata")'],
  ...
  ["html local capability client selector", html, "localCapabilityClientSelect"],
  ["html local capability client config", html, "copyLocalCapabilityClientConfigBtn"],
  ["html local capability token", html, "copyLocalCapabilityTokenBtn"],
  ...
  ["js local MCP Codex config", js, "[mcp_servers.outilsia_local]"],
  ["js local MCP Claude config", js, "Bearer ${OUTILSIA_LOCAL_MCP_TOKEN}"],
  ["html local MCP label", html, "Serveur MCP local"],
  ["js local MCP protocol", js, "2025-11-25"],
  ["js local MCP read only tool", js, "outilsia_get_machine_profile"],
  ...
  ["rust local MCP initialize", rust, "\"initialize\" => Ok(mcp_initialize_result(params))"],
